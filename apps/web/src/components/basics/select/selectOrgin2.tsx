...
interface ISelectProps<T = unknown>{
  onChange?: (event: React.MouseEvent | React.KeyboardEvent | React.FocusEvent | null, value: StringOrNumber) => void;
  value?: T | any;
  placeholder?: React.ReactNode;
}

export default function UnstyledSelectObjectValues(props:ISelectProps) {

  const [selectValue, setSelectValue] = useState<Character | null>(characters[0]);
